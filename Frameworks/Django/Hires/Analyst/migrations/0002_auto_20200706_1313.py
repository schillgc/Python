# Generated by Django 3.0.3 on 2020-07-06 17:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='job',
            name='active',
            field=models.BooleanField(default=True, verbose_name='Actively Seeking This Position'),
        ),
        migrations.AddField(
            model_name='job',
            name='applied',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=500, verbose_name="Company Contact's Name"),
        ),
        migrations.AddField(
            model_name='job',
            name='email_of_contact',
            field=models.EmailField(blank=True, max_length=254, verbose_name="Company Contact's Email Address"),
        ),
        migrations.AddField(
            model_name='job',
            name='email_of_recruiter',
            field=models.EmailField(blank=True, max_length=254, verbose_name="Recruiter's Email Address"),
        ),
        migrations.AddField(
            model_name='job',
            name='interviewed',
            field=models.BooleanField(default=False, verbose_name='Interviewed'),
        ),
        migrations.AddField(
            model_name='job',
            name='number_of_hours_per_week',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='# of Hours / Week'),
        ),
        migrations.AddField(
            model_name='job',
            name='number_of_weeks',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True, verbose_name='# of Weeks'),
        ),
        migrations.AddField(
            model_name='job',
            name='phone_number_of_contact',
            field=phone_field.models.PhoneField(blank=True, help_text="Company Contact's Phone Number", max_length=31),
        ),
        migrations.AddField(
            model_name='job',
            name='phone_number_of_recruiter',
            field=phone_field.models.PhoneField(blank=True, help_text="Recruiter's Phone Number", max_length=31),
        ),
        migrations.AddField(
            model_name='job',
            name='rate_per_hour',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default_currency='USD', max_digits=5, null=True, verbose_name='Pay Rate / Hour'),
        ),
        migrations.AddField(
            model_name='job',
            name='rate_per_hour_currency',
        ...
        migrations.AddField(
            model_name='job',
            name='recruiter',
            field=models.CharField(blank=True, max_length=500, verbose_name="Recruiter's Name"),
        ),
        migrations.AddField(
            model_name='job',
            name='recruiting_company',
            field=models.CharField(blank=True, max_length=200, verbose_name='Recruiting Company'),
        ),
        migrations.AddField(
            model_name='job',
            name='remote',
        ...
        migrations.AddField(
            model_name='job',
            name='screened',
            field=models.BooleanField(default=False, verbose_name='Screened By Recruiter'),
        ),
        migrations.AddField(
            model_name='job',
            name='slug',
            field=models.SlugField(default='<django.db.models.fields.CharField>_<django.db.models.fields.CharField>', null=True),
        ),
        migrations.AddField(
            model_name='job',
            name='thanked',
            field=models.BooleanField(default=False, verbose_name='Thanked'),
        ),
        migrations.AddField(
            model_name='job',
            name='website',
            field=models.URLField(blank=True, verbose_name='Application Website'),
        ),
        ...
        migrations.AlterField(
            model_name='job',
            name='title',
            field=models.CharField(blank=True, max_length=200, verbose_name='Job Title'),
        ),
    ]
